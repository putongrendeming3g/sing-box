...
type HTTP2Options struct {
	...
	StreamReceiveWindow     byteformats.MemoryBytes `json:"stream_receive_window,omitzero"`
	ConnectionReceiveWindow byteformats.MemoryBytes `json:"connection_receive_window,omitzero"`
